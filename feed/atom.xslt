...
<html>
	...
	<body>
		...
		<p>
			This is the RSS <a href="//roblog.nl/rss">news feed</a> for the <em><xsl:value-of select="/atom:feed/atom:title"/></em> website.  It is meant for <a href="//en.wikipedia.org/wiki/News_aggregator">news readers</a>, not humans. You can subscribe to it for free:
		</p>
